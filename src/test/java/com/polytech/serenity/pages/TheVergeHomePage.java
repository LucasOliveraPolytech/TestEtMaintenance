...
public class TheVergeHomePage extends PageObject {
	...
	//@FindBy(xpath = "/html/body/div[3]/div[1]/div[1]/div/header/div/nav/ul/li[7]/a")
	private WebElementFacade videoButton = find(By.cssSelector("li.c-global-header__link:nth-child(7) > a:nth-child(1)")).getValue();
